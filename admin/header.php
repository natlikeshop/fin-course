...
<head>
    ...
    <title>แผงควบคุมระบบ (Admin) | Fin-Course</title>
    ...
    <style>
        ...
        .sidebar-profile { padding-bottom: 20px; border-bottom: 1px solid var(--border-color); margin-bottom: 20px; text-align: center; }
...
<div class="dashboard-layout animate-slide-in">
    <div class="dashboard-sidebar">
        <div class="sidebar-profile">
            <div style="width: 60px; height: 60px; border-radius: 50%; background: var(--secondary-grad); color: #fff; font-weight: 700; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin: 0 auto 10px; box-shadow: var(--shadow-purple);">
                <?= mb_substr($admin['fullname'], 8, 1) ?: 'A' ?>
            </div>
            <div class="sidebar-profile-info">
                <div style="overflow: hidden;">
                    <div style="font-weight: 700; font-size: 0.95rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?= htmlspecialchars($admin['fullname']) ?></div>
                    <div style="font-size: 0.75rem; color: var(--accent-purple); font-weight: 600; text-transform: uppercase;">ผู้ดูแลระบบ (Admin)</div>
                </div>
        ...
        <div class="sidebar-nav-links">
            <a href="index.php?page=admin_overview" class="sidebar-link <?= ($page === 'admin_overview') ? 'active' : '' ?>">
                <i class="fa-solid fa-chart-pie"></i> ภาพรวมระบบ & สถิติ
            </a>
            <a href="index.php?page=admin_users" class="sidebar-link <?= ($page === 'admin_users') ? 'active' : '' ?>">
                <i class="fa-solid fa-users"></i> จัดการบัญชีสมาชิก
            </a>
            <a href="index.php?page=admin_courses" class="sidebar-link <?= ($page === 'admin_courses') ? 'active' : '' ?>">
                <i class="fa-solid fa-graduation-cap"></i> จัดการหลักสูตรเรียน
            </a>
        </div>
